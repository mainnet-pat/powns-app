...
const DNS = new Token(
  2000,
  '0xE6bBD3B28C14bf325b91203De60aF2458DBFc5b6',
  18,
  'POWNS',
  'Đoge Name Service'
)
const xDNS = new Token(
  2000,
  '0x83342Af9494D250bC7E2C5ac08138D6b59BaBF21',
  18,
  'xPOWNS',
  'POWNSBar'
)
...
const dnsProps = {
  ...
  image:
    'https://raw.githubusercontent.com/dogmoneyswap/assets/master/blockchains/dogechain/assets/0xE6bBD3B28C14bf325b91203De60aF2458DBFc5b6/logo.png'
}
...
const xdnsProps = {
  ...
  image:
    'https://raw.githubusercontent.com/dogmoneyswap/assets/master/blockchains/dogechain/assets/0x83342Af9494D250bC7E2C5ac08138D6b59BaBF21/logo.png'
}
        ...
        <div className="flex flex-col w-full max-w-xl mx-auto md:m-0">
          ...
          <div className="flex items-center justify-between w-full mt-6">
            ...
            <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
              {`1 xPOWNS = ${xSushiPerSushi.toFixed(4)} POWNS`}
            </div>
          </div>
          ...
          <InputWrapper>
            <TextInput
              ...
              placeholder={activeTab === 0 ? 'POWNS' : 'xPOWNS'}
            />
            <Button
              type={'hollow-primary'}
              ...
              <div className="flex flex-col flex-grow">
                ...
                <div className="flex items-center ml-8 space-x-4 md:ml-0">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <p className="text-sm md:text-base text-primary">xPOWNS</p>
                    {walletConnected &&
              ...
              <div className="flex flex-col flex-grow md:mt-10">
                ...
                <div className="flex items-center ml-8 space-x-4 md:ml-0">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <p className="text-sm md:text-base text-primary">POWNS</p>
                  </div>
                </div>
              </div>
            </div>
